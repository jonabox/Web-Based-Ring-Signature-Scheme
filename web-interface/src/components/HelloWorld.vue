    ...
    <v-tabs-items v-model="tab">
      <v-tab-item>
        <v-card class="pa-10" flat>
          <v-file-input
            chips
            label="Attach .PEM file containing the public keys of all ring members"
          ...
          <v-text-field
            ...
            v-model="password"
          ></v-text-field>
          <v-text-field prepend-icon="mdi-text" label="Enter message to sign" v-model="message"></v-text-field>
